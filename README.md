...
Update on 2018/12/04. We plan to refactor all of our implementations in the future weeks. Keep waiting, and we plan to release the optimized method that can reduce the memory cost and computation cost largely if can ensure the performance is OK.
