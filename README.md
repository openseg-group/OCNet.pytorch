...
## Acknowledgment
This project is created based on the base code (deeplabv3, PSPnet with sync bn) provided by [Zilong Huang](g](https://github.com/speedinghzl). He retains all the copyright of the base code. 
